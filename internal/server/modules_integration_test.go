...
func TestDashboardMountedAndAlwaysOn(t *testing.T) {
	...
	h := NewWithModules(svc, jm, reg, mgr, nil, nil, nil, "/", nil, []byte("test-secret-32-bytes-long-xxxxxx"), nil, nil, nil)
...
func publicTestEnv(t *testing.T) http.Handler {
	...
	return NewWithModules(svc, jm, reg, mgr, nil, nil, nil, "/", nil, []byte("test-secret-32-bytes-long-xxxxxx"), nil, nil, nil)
}
